...
export default function Register() {
    ...
    return (
        <div className="my-4 bg-white rounded-[10px] flex">
            <div className="w-[50%] py-45 flex justify-center items-center">
            ...
            <div className="w-[50%] flex flex-col justify-center">
                ...
                <div className="flex flex-col mt-8">
                    ...
                    <input type="text" id="name" placeholder="Jhon Deo" className="mt-2 p-2 w-[80%] rounded-[6px] border border-[#CCCCCC] focus:outline-none"/>
                </div>
