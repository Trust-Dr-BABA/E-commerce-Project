...
export default function Membership() {
  return (
    <div className="flex justify-center items-center text-white p-6 gap-2 rounded-[10px] bg-[url('/membership-banner.png')] bg-cover bg-center h-full w-full rounded-[10px]">
